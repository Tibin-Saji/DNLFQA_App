...
class HomeNotMemberScreen extends StatefulWidget {
  const HomeNotMemberScreen({Key? key, required this.isMemFunc})
      : super(key: key);
  final Function isMemFunc;

  @override
  _HomeNotMemberScreenState createState() => _HomeNotMemberScreenState();
}
...
class _HomeNotMemberScreenState extends State<HomeNotMemberScreen> {
  var isLoading;
  var id;
  bool darkTheme = true;
  ...
  Widget build(BuildContext context) {
    ...
    final scrollBtns = [
      MyElevatedButton(
          ...
          child: FittedBox(
            fit: BoxFit.cover,
            child: TextTitleRegular(text: "Upcoming\nMeetings", color: color),
          )),
      MyElevatedButton(
          style: style,
          onPressed: () {
          ...
          child: FittedBox(
            fit: BoxFit.cover,
            child: TextTitleRegular(text: "Sermon\nPlaylist", color: color),
          )),
      MyElevatedButton(
          style: style,
          onPressed: () {},
          child: TextTitleRegular(text: "Forms", color: color)),
      // MyElevatedButton(
      //     style: style,
      //     onPressed: () {},
